              ...
              <div className="mt-5 flex flex-wrap items-stretch gap-2">
                {p.phases.map((ph, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <div className="min-w-[150px] rounded-lg border border-white/[0.06] bg-white/[0.02] p-3 transition-colors group-hover:border-white/[0.1]">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground/60">{`Phase ${i + 1}`}</span>
                        {ph.hitl ? (
