...
$AgentSecretKeys = @{
    ...
    gitlab_agent           = @("GITLAB_PERSONAL_ACCESS_TOKEN", "GITLAB_TOKEN", "GITLAB_URL", "GITLAB_API_URL", "GITLAB_PROJECT_PATH", "GITLAB_MCP_HTTP_URL")
    orchestrator_agent     = @()
    orchestrator_agent_vpc = @()
    security_agent         = @()
    qa_agent               = @("GITLAB_PERSONAL_ACCESS_TOKEN", "GITLAB_TOKEN", "GITLAB_URL", "GITLAB_API_URL", "GITLAB_MCP_HTTP_URL")
}
