...
class Settings(BaseSettings):
    ...
    service_name: str = Field("it-asset-lifecycle", alias="SERVICE_NAME")

    # ── Postgres (RDS) ───────────────────────────────────────────────────
    database_url: str = Field("", alias="DATABASE_URL")
    postgres_schema: str = Field("it_asset_lifecycle", alias="POSTGRES_SCHEMA")
    ...
    # ── Fernet encryption ────────────────────────────────────────────────
    asset_encryption_key: str = Field("", alias="ASSET_ENCRYPTION_KEY")
