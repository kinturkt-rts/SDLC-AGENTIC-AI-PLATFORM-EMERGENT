...
from app.routers import alerts, assets, auth, employees, health, reports
...
def create_app() -> FastAPI:
    ...
    application.include_router(assets.router, prefix="/assets")
    application.include_router(employees.router, prefix="/employees")
    application.include_router(alerts.router, prefix="/alerts")
