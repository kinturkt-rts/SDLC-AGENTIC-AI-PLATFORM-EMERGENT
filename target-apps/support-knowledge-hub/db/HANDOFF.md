...
_Generated 2026-06-25 14:40 UTC by database-agent._
...
2. `target-apps/support-knowledge-hub/db/sql/002_users.sql`
3. `target-apps/support-knowledge-hub/db/sql/003_categories.sql`
4. `target-apps/support-knowledge-hub/db/sql/004_articles.sql`
5. `target-apps/support-knowledge-hub/db/sql/005_article_chunks.sql`
6. `target-apps/support-knowledge-hub/db/sql/006_search_logs_and_items.sql`
7. `target-apps/support-knowledge-hub/db/sql/007_feedback.sql`
8. `target-apps/support-knowledge-hub/db/sql/008_pinned_articles.sql`
9. `target-apps/support-knowledge-hub/db/sql/011_seed.sql`
