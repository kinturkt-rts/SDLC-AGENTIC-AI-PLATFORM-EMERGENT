...
class Settings(BaseSettings):
    ...
    service_name: str = Field("support-knowledge-hub", alias="SERVICE_NAME")

    # -- Postgres (RDS) --
    database_url: str = Field("", alias="DATABASE_URL")
    postgres_schema: str = Field("support_knowledge_hub", alias="POSTGRES_SCHEMA")
    ...
    # -- Embedding --
    embed_model_name: str = Field("all-MiniLM-L6-v2", alias="EMBED_MODEL_NAME")
