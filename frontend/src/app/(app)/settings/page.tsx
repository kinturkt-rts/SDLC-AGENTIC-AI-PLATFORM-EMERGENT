...
import { API_BASE_URL, USING_REPO_DATA } from '@/src/lib/api';
      ...
      <Card className="max-w-2xl border-white/[0.06] bg-card/80 p-5">
        ...
        <div className="mt-4 space-y-2">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-white/[0.06] bg-muted/20 p-2.5 text-xs text-muted-foreground">
            ...
            {USING_REPO_DATA
              ? 'No external API configured — the UI reads live data from backend/ (target-apps/, agents/pipeline/, docs/) via /api/v1. Set NEXT_PUBLIC_API_BASE_URL to use a remote platform API instead.'
